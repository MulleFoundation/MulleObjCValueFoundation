#ifndef mulle_objc_value_foundation_include_h__
#define mulle_objc_value_foundation_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "MulleObjCValueFoundation-include.h" to keep the #include statements in the
...
#include "_MulleObjCValueFoundation-include.h"

#if defined( MULLE_OBJC_VALUE_FOUNDATION_BUILD) || defined( MULLE_FOUNDATION_BASE_BUILD)
# define MULLE_OBJC_VALUE_FOUNDATION_GLOBAL    MULLE_C_GLOBAL
#else
# if defined( MULLE_OBJC_VALUE_FOUNDATION_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE_OBJC_VALUE_FOUNDATION_INCLUDE_STATIC))
#  define MULLE_OBJC_VALUE_FOUNDATION_GLOBAL   MULLE_C_EXTERN_GLOBAL
# else
#  define MULLE_OBJC_VALUE_FOUNDATION_GLOBAL   extern
# endif
#endif
