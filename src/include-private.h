#ifndef mulle_objc_value_foundation_include_private_h__
#define mulle_objc_value_foundation_include_private_h__
...
#include "_MulleObjCValueFoundation-include-private.h"
